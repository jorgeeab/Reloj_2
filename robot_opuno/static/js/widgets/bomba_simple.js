  ...
  function factory(ctx){
    ...
    return {
      ...
      onTelemetry(data){
        ...
        // Activa si hay objetivo pendiente con sensor, o si la energía de bomba > 0 sin sensor
        const bombaActiva = usarSensor ? objetivoPendiente : (energiaBomba > 0);
        const flowActual = Number.isFinite(data.flowActual) ? Number(data.flowActual) : (bombaActiva ? caudalCfg : 0);
